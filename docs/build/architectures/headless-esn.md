---
description: Reservoir-only feature extractor — no readout, raw states out, ready to embed in any larger PyTorch model.
---
...
The full nonlinear reservoir of [classic_esn](classic-esn.md) — tanh
activation, scaled spectrum, random bias — minus the readout. The factory
accepts no readout arguments; what you bolt onto the states is your model's
business, not the factory's.
...
- [Architectures](index.md) — the rest of the premade catalog.
