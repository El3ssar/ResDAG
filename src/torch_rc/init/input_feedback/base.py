...
See Also
--------
torch_rc.init.input_feedback.registry : Registry of available initializers.
...
class InputFeedbackInitializer(ABC):
    ...
    See Also
    --------
    torch_rc.init.input_feedback.registry : Get initializers by name.
    torch_rc.layers.ReservoirLayer : Uses these initializers.
    """
